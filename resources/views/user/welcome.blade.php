  ...
  <main id="main">
    ...
    <section id="services" class="services">
      <div class="container">
        ...
        <div class="section-title">
          <h2 style="color: #1977cc">Services</h2>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0">
            <div class="icon-box">
              ...
              <h4 class=""><a href="">POLI UMUM</a></h4>
    ...
    <section id="services" class="services">
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg-4 col-md-6  align-items-stretch mt-4 mt-lg-0 rounded">
              <div class="icon-box" style="border-radius: 25px">
                {{-- <div class="icon"><i class="fas fa-hospital-user"></i></div> --}}
                <h4 class="title"><a href="">NOMOR ANTRIAN ANDA</a></h4>
                <h4 class="title"><a href="">17</a></h4>
    ...
    <section id="doctors" class="doctors">
      <div class="container">
        ...
        <div class="section-title">
          <h2 style="color: #1977cc">Doctors</h2>
          <p>Magnam dolores commodi suscipit. Necessitatibus eius consequatur ex aliquid fuga eum quidem. Sit sint consectetur velit. Quisquam quos quisquam cupiditate. Et nemo qui impedit suscipit alias ea. Quia fugiat sit in iste officiis commodi quidem hic quas.</p>
        </div>
    ...
    <section id="contact" class="contact">
      ...
      <div>
        <iframe style="border:0; width: 100%; height: 350px;" src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d248.53512762906385!2d123.06313665750224!3d-4.671885558648133!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2da2294bc7902c43%3A0x7731b825717b598a!2sPUSKESMAS%20LAMBALE!5e0!3m2!1sid!2sid!4v1710009980018!5m2!1sid!2sid" frameborder="0" allowfullscreen></iframe>
      </div>
